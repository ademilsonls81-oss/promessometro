---
titulo: "Fortalecer o comércio de produtos de origem animal, responsáveis"
...
# Fortalecer o comércio de produtos de origem animal, responsáveis
...
Fortalecer o comércio de produtos de origem animal, responsáveis por asegurar a qualidade de produtos destinados ao mercado interno, bem como de produtos para exportação, fortalecendo a implementação dos selos de inspeção federal (SIF), estadual (SIE) e municipal (SIM).
