---
titulo: "Promover a integração da atuação dos órgãos da Segurança"
...
# Promover a integração da atuação dos órgãos da Segurança
...
Promover a integração da atuação dos órgãos da Segurança Pública estadual com as Guardas Municipais, onde houver, e as Polícias Federais, para compartilhamento de informações de inteligência, realização de ações cordenadas e para diminuir o tempo de resposta das ocorências.
