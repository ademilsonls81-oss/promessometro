---
titulo: "Criar o programa Jovem Monitor, com a seleção e contratação por"
...
# Criar o programa Jovem Monitor, com a seleção e contratação por
...
Criar o programa Jovem Monitor, com a seleção e contratação por período de 6 meses de jovens que estejam cursando o ensino médio, ensino profisionalizante e superior (programas de extensão). [Inserido também na pág. 46]
