---
titulo: "Criar o Índice de Gestão Descentralizada (IGD-SE) para os"
...
# Criar o Índice de Gestão Descentralizada (IGD-SE) para os
...
Criar o Índice de Gestão Descentralizada (IGD-SE) para os municípios, contemplando recursos para adequações e manutenção dos espaços físicos dos Conselhos de Asistência Social.
