---
titulo: "Implementar um sistema de gestão inovador na gestão pública,"
...
# Implementar um sistema de gestão inovador na gestão pública,
...
Implementar um sistema de gestão inovador na gestão pública, com uso de painéis de monitoramento e controle, integração entre as secretarias e organizações, maior e melhor interface, diálogo e transversalidade com o usuário, reforço ao uso da ciência, tecnologia e inovação para a excelência na prestação do serviço público.
