---
titulo: "Instituir a Semana Estadual de Proteção Animal (SEPA), na primeira"
...
# Instituir a Semana Estadual de Proteção Animal (SEPA), na primeira
...
Instituir a Semana Estadual de Proteção Animal (SEPA), na primeira semana de outubro, com realização de campanhas de conscientização, atividades nas escolas, mutirões de castração, campanhas de adoção etc.
