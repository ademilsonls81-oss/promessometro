---
titulo: "Implementar o projeto Sergipe Energia para investir em ações"
...
# Implementar o projeto Sergipe Energia para investir em ações
...
Implementar o projeto Sergipe Energia para investir em ações regionais para exploração e complexos de geração de energias Termoelétrica, Eólica e Solar, inclusive o projeto de Energia Solar em Canindé de São Francisco (ENESF).
