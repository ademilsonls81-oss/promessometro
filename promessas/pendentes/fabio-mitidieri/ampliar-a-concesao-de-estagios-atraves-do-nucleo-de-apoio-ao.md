---
titulo: "Ampliar a concesão de estágios através do Núcleo de Apoio ao"
...
# Ampliar a concesão de estágios através do Núcleo de Apoio ao
...
Ampliar a concesão de estágios através do Núcleo de Apoio ao Trabalhador (NAT), Centro de Integração Empresa Escola (CIE) e outras organizações congêneres.
