---
titulo: "Criar um padrão estrutural para construção e manutenção predial"
...
# Criar um padrão estrutural para construção e manutenção predial
...
Criar um padrão estrutural para construção e manutenção predial das Instalações e equipamentos públicos da rede estadual, atualização da frota e aparelhamento das Secretarias e Órgãos de Estado.
