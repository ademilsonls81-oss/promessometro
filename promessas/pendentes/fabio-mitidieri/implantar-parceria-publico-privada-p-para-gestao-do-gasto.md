---
titulo: "Implantar Parceria Público-Privada (P) para gestão do gasto do"
...
# Implantar Parceria Público-Privada (P) para gestão do gasto do
...
Implantar Parceria Público-Privada (P) para gestão do gasto do Governo do Estado com energia, verificando e controlando as matrizes energéticas.
