---
titulo: "Criar uma força tarefa entre a Secretaria de Estado da Fazenda e"
...
# Criar uma força tarefa entre a Secretaria de Estado da Fazenda e
...
Criar uma força tarefa entre a Secretaria de Estado da Fazenda e as Secretarias Municipais de Fazenda, para a elaboração de um convênio de parceria sobre a fiscalização do ICMS e treinamento e capacitação das equipes para a apuração do valor adicionado fiscal que compõem a cota parte deste imposto municipal, e ainda dar transparência total do valor arecadado de ICMS e os repases aos municípios.
