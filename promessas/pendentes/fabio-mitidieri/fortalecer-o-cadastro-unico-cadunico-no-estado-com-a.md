---
titulo: "Fortalecer o Cadastro Único (CadÚnico) no estado, com a"
...
# Fortalecer o Cadastro Único (CadÚnico) no estado, com a
...
Fortalecer o Cadastro Único (CadÚnico) no estado, com a retomada de suas finalidades e gestão compartilhada, propondo ações em feiras, ações itinerantes com rede móvel do Centro de Referência da Asistência Social (CRAS), entre outras.
