---
titulo: "FÁBRICAS DE BLOQUETES Ampliar a fabricação de blocos sextavados de concreto (bloquetes) e priorizar a pavimentação de ru"
...
# FÁBRICAS DE BLOQUETES Ampliar a fabricação de blocos sextavados de concreto (bloquetes) e priorizar a pavimentação de ru
...
FÁBRICAS DE BLOQUETES Ampliar a fabricação de blocos sextavados de concreto (bloquetes) e priorizar a pavimentação de ruas em municípios afetados por enchentes e inundações, assim como bairros de maior vulnerabilidade social.
