---
titulo: "MUNICÍPIOS CAPACITADOS Implementar, em parceria com os municípios, programa de capacitação de técnicos das prefeituras m"
...
# MUNICÍPIOS CAPACITADOS Implementar, em parceria com os municípios, programa de capacitação de técnicos das prefeituras m
...
MUNICÍPIOS CAPACITADOS Implementar, em parceria com os municípios, programa de capacitação de técnicos das prefeituras municipais para utilização do sistema do PROCON, com objetivo de promover maior acesso e agilidade para registro de reclamações e processos.
