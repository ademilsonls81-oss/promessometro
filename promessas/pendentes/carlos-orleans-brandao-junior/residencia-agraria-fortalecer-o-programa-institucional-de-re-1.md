---
titulo: "RESIDÊNCIA AGRÁRIA Fortalecer o Programa Institucional de Residência em Ciências"
...
# RESIDÊNCIA AGRÁRIA Fortalecer o Programa Institucional de Residência em Ciências

## 📌 Dados da Promessa

| Campo | Valor |
|-------|-------|
| **Político** | Carlos Orleans Brandao Junior |
| **Partido** | PSB |
| **Cargo** | governador |
| **Estado** | Maranhao |
...
RESIDÊNCIA AGRÁRIA Fortalecer o Programa Institucional de Residência em Ciências Agrárias, visando a inserção no mercado de trabalho de um maior número de profissionais egressos das áreas de Agronomia, Engenharia Agronômico, Engenharia de Pesca, Engenharia Florestal, Medicina Veterinária e Zootecnia, formados a, no máximo, 02 anos em instituições de ensino superior do Estado do Maranhão.
...
- **Link:** 
- **Veículo/Plataforma:** Plano de Governo Maranhao
