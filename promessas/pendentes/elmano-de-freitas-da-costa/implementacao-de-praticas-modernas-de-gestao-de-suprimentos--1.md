---
titulo: "Implementação de práticas modernas de gestão de suprimentos da saúde, priorizando a utilização dos"
...
# Implementação de práticas modernas de gestão de suprimentos da saúde, priorizando a utilização dos
...
Implementação de práticas modernas de gestão de suprimentos da saúde, priorizando a utilização dos recursos para atender as urgências da população, com ênfase no bom acolhimento dos usuários da rede pública;
