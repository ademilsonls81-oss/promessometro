---
titulo: "Em 2021, iniciamos um processo de reuniões semanais com os comandantes e delegados de cada Região Integrada de Segurança"
...
# Em 2021, iniciamos um processo de reuniões semanais com os comandantes e delegados de cada Região Integrada de Segurança
...
Em 2021, iniciamos um processo de reuniões semanais com os comandantes e delegados de cada Região Integrada de Segurança Pública do Estado, que permitiu que várias medidas exitosas fossem implantadas no sentido de diminuir as taxas de crimes nas regiões;
