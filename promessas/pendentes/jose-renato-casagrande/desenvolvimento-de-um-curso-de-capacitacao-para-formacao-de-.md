---
titulo: "Desenvolvimento de um curso de Capacitação para Formação de Times de Alta Performance, pelo meio do qual se está introdu"
...
# Desenvolvimento de um curso de Capacitação para Formação de Times de Alta Performance, pelo meio do qual se está introdu
...
Desenvolvimento de um curso de Capacitação para Formação de Times de Alta Performance, pelo meio do qual se está introduzindo no ES o modelo ProblemOriented Policing (POP), que é utilizado nos principais departamentos de polícia pelo mundo afora;
