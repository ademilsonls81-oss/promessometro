---
titulo: "Implantar, na agência DESENVOLVE ALAGOAS, um programa de apoio à construção e reforma da casa própria para a população a"
...
# Implantar, na agência DESENVOLVE ALAGOAS, um programa de apoio à construção e reforma da casa própria para a população a
...
Implantar, na agência DESENVOLVE ALAGOAS, um programa de apoio à construção e reforma da casa própria para a população alagoana de baixa renda;
