---
titulo: "Construção de 20 novas creches em regiões de maior vulnerabilidade social"
politico: "Bruno Reis"
partido: "União Brasil"
cargo: "prefeito"
estado: "Bahia"
data_promessa: "2024-10-01"
fonte_original: ""
status: "🔵 parcial"
categoria: "Educação"
...
# Construção de 20 novas creches em regiões de maior vulnerabilidade social
...
Avaliacao herdada do status original (cumprida, score 90). IA falhou: Groq 429: {"error":{"message":"Rate limit reached for model `llama-3.3-70b-versatile` in organization `org_01kntbavfjebrrayvz8wepz0kr` service tier `on_demand` on tokens per day (TPD): Limit 100000, Used 98533,
...
|------|----------------|-------------|-------------|------|
| 2024-10-01 | — | 🟡 pendente | sistema | Promessa cadastrada |
...
- [2024-10-01] Promessa cadastrada. Aguardando início de verificação.
