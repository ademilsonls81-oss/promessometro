---
titulo: "Programa de concessão de rodovias estaduais mineiras para reduzir custos de manutenção"
politico: "Romeu Zema"
partido: "Novo"
cargo: "governador"
estado: "Minas Gerais"
...
ultima_atualizacao: "2022-10-01"
---




# Programa de concessão de rodovias estaduais mineiras para reduzir custos de manutenção
...
Avaliacao herdada do status original (cumprida, score 90). IA falhou: Groq 429: {"error":{"message":"Rate limit reached for model `llama-3.3-70b-versatile` in organization `org_01kntbavfjebrrayvz8wepz0kr` service tier `on_demand` on tokens per day (TPD): Limit 100000, Used 98387,
...
- **Link:** 
- **Veículo/Plataforma:** agenciaminas.mg.gov.br
...
|------|----------------|-------------|-------------|------|
| 2022-10-01 | — | 🟡 pendente | sistema | Promessa cadastrada |
...
- [2022-10-01] Promessa cadastrada. Aguardando início de verificação.
