---
titulo: "Construção de um Modelo Padrão para Escolas Indígenas"
...
# Construção de um Modelo Padrão para Escolas Indígenas
...
Construção de um modelo padrão para escolas indígenas[cite: 23].
